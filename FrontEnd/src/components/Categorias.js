...
function Categorias() {
    ...
    return (
        ...
        <div className=""> 
            <div className="mx-auto max-w-2xl px-4 py-8 sm:px-6 sm:py-16 lg:max-w-7xl lg:px-8 " style={{marginTop: "-30px"}}>
        <div className="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 xsm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
          {Categorias.map((categoria) => (
            ...
            className="h-40 w-full object-cover object-center group-hover:opacity-75"  // Adjust the height (h-40) as needed
            />
              </div>
              <h3 className="mt-2 text-sm font-bold ">{categoria.NombreCategoria}</h3>
